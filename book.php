            ...
            <label for="vehicle5"> 11:30 - 12:00 AM</label></td>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td colspan="3">
                                                ...
                                                <select class="form-control" onChange="check_slot_Availability(this.value)" id="book_time" name="time">
                                                    <option value="">Select Time</option>
                                                    <?php     
   $sql1 = "SELECT * FROM book_time ORDER BY bid ASC";
...
<script>
    function check_slot_Availability(book_time) {
        //$("#loaderIcon").show();
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                ...
                if (obj.is_error == "No") {
                   ...
                   $("#book_time option[value='"+book_time+"']").attr("disabled","disabled");
                    
                    
                    
                   // $("#book_time").attr('disabled', 'disabled'));
                }
